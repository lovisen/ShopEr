<%@ Page Language="VB" MasterPageFile="~/ShopErMaster.master" AutoEventWireup="false" CodeFile="ProductDetail.aspx.vb" Inherits="ProductDetail" title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 Rekomenderade produkter<br />Rencentioner<br /><br />
     <asp:Button ID="back" runat="server" Text="Tillbaka" /><asp:Button ID="Button1" runat="server" Text="Köp" />
 </div>
